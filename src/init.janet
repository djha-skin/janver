# src/init.janet
#
# Compare Debian, Semantic Versioning, Maven, and RubyGems versions.
...
(deftest ruby-version
  (test (peg/match ruby-version "1.2.3")
        @[[:number "1"] [:number "2"] [:number "3"]])
  (test (peg/match ruby-version " 1.2-rc1 ")
        @[[:number "1"] [:number "2"] [:string "pre"]
          [:string "rc"] [:number "1"]])
  (test (peg/match ruby-version "") @[[:number "0"]])
  (test (peg/match ruby-version "   \t\n") @[[:number "0"]])
  (test (peg/match ruby-version "1.0a10")
        @[[:number "1"] [:number "0"] [:string "a"] [:number "10"]])
  (test (peg/match ruby-version "1.0-rc-1")
        @[[:number "1"] [:number "0"] [:string "pre"] [:string "rc"]
          [:string "pre"] [:number "1"]])
  (test (peg/match ruby-version "1.0.0.a")
        @[[:number "1"] [:number "0"] [:number "0"] [:string "a"]])
  (test (peg/match ruby-version "1..2") nil)
  (test (peg/match ruby-version ".1") nil)
  (test (peg/match ruby-version "1.") nil)
  (test (peg/match ruby-version "1-") nil)
  (test (peg/match ruby-version "1a") nil)
  (test (peg/match ruby-version "1.é") nil))
...
(defn ruby-vercmp
  ...
  `
  [a b]
  (let [parsed-a (peg/match ruby-version a)
        parsed-b (peg/match ruby-version b)]
...
(deftest ruby-vercmp
  (test (ruby-vercmp "" "0") 0)
  (test (ruby-vercmp " 1.0 " "1") 0)
  (test (ruby-vercmp "1.0" "1.0.0") 0)
  (test (ruby-vercmp "1.0.0.a" "1.0.a") 0)
  (test (< (ruby-vercmp "1.0.a9" "1.0.a10") 0) true)
  (test (< (ruby-vercmp "1.0.a1" "1.0") 0) true)
  (test (< (ruby-vercmp "1.0.a2" "1.0.b1") 0) true)
  (test (= (ruby-vercmp "1.0-rc1" "1.0.pre.rc1") 0) true)
  (test (> (ruby-vercmp "1.0" "1.0-rc1") 0) true)
  (test (< (ruby-vercmp "1.0.0.1" "1.0") 0) true)
  (test (= (ruby-vercmp "1" "1.0.0.0") 0) true)
  (test (> (ruby-vercmp "1.0.0.0" "1") 0) true)
  (test (ruby-vercmp "1.0000000000000000000000000000001"
                     "1.1") -1)
  (test (ruby-vercmp "1.0.a" "1.0.0.a") 0))
